  ...
  return (
    ...
    >
      <View style={styles.overlay}>
        <View className="bg-white rounded-[24px] w-[340px] p-6 items-center shadow-lg">
          ...
          <View className="flex-row items-center justify-between w-full">
            <TouchableOpacity 
              onPress={onClose}
              className="flex-1 bg-neutral-100 h-[48px] rounded-full items-center justify-center mr-2"
            >
            ...
            <TouchableOpacity 
              onPress={onEnable}
              className="flex-1 bg-primary h-[48px] rounded-full items-center justify-center ml-2"
            >
